...
public class SignUpFragment extends AuthFragment{
    TextInputEditText idLogin,passLogin;
    @BindViews(value = {R.id.lupapassword_id,
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if(view!=null){
            ...
            foldStuff();
//            idLogin = (TextInputEditText) view.findViewById(R.id.email_input);
//            passLogin = (TextInputEditText) view.findViewById(R.id.password_input);
    ...
    private void foldStuff(){
        //saat tombol lupa password berada di samping
